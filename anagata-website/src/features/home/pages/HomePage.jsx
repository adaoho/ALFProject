...
import { TaxImage } from "../../news/assets/export-assets";
import { useFetchPosts } from "../../../stores/mainAction";
import { useDispatch, useSelector } from "react-redux";
import { setDrawerHeader } from "../../../stores/mainSlices";
...
const HomePage = () => {
  ...
  const { drawerHeader } = useSelector((state) => state.main);
  ...
  return (
    <>
      ...
      <MainLayout className={"hidden lg:flex"}>
                ...
                <SwiperSlide>
                  <div className="relative w-full h-full">
                    <img
                      ...
                      className="object-cover z-0 rounded-3xl absolute w-full h-full"
                    />
                    <div className="flex flex-col gap-y-4 absolute px-24 pt-16">
                      ...
                      <h1 className="text-[42px] text-white font-bold max-w-[70%] truncate-twoline">
                      ...
                      <SwiperSlide key={index}>
                        <div className="flex gap-x-12 h-full float-start w-full">
                          <img
                            ...
                            alt=""
                            className="w-[20rem] h-full rounded-3xl object-cover"
                          />
        ...
        >
          ...
          <div
            data-aos="fade-up"
            data-aos-offset="100"
            className="w-full grid grid-cols-3 pl-3 py-10"
          >
      ...
      <Drawer
        ...
        overlay={false}
        className="flex justify-end w-full bg-transparent z-50"
        // onScroll={false}
      >
        <div className="w-[85%] bg-white h-full items-start flex p-20 overflow-scroll gap-x-6">
      ...
      {drawerPeople && (
        <motion.div
          className="bg-black/80 inset-0 fixed z-40"
          initial={{ opacity: 0 }}
          animate={{ opacity: drawerPeople ? 1 : 0 }}
          transition={{
            duration: 0.6,
            ease: "easeInOut",
          }}
